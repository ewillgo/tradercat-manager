...
Constant.USER.LOGIN_CAPTCHA_URL = "http://manager-backend.tradercat.net/user/loginCaptcha";
Constant.USER.REGISTER_CAPTCHA_URL = "http://manager-backend.tradercat.net/user/registerCaptcha";
Constant.USER.REGISTER_URL = "http://manager-backend.tradercat.net/user/register";
Constant.USER.LOGIN_URL = "http://manager-backend.tradercat.net/user/login";
